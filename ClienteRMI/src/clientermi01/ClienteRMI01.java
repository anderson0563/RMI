...
public class ClienteRMI01 {
    ...
    public static void main(String[] args) throws NotBoundException, MalformedURLException, RemoteException {
        ...
        boolean denovo;
		do{
			String[] options = {"Fibonacci", "Pi", "Sair"};
			...
			switch(escolha){
				case 0:
					...
					try{
						int fatorial = look_up.Fibonacci(new Numero(n));
                                                imagem = new ImageIcon("./src/fat.png");
						JOptionPane.showMessageDialog(null, "Cálculo do fibonacci de " + n + " vale " + String.valueOf(fatorial), "Resultado", JOptionPane.INFORMATION_MESSAGE, imagem);
